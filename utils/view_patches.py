...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_h5', help='input .h5 file containing patches to be visualized')
    parser.add_argument('--num_patches', help='number of patches to be viewed from dataset')
    ...
    view_patches(args.input_h5, args.num_patches)
